...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class GazeInputManager : MonoBehaviour
    {
        ...
        protected void Awake()
        {
            ...
            {
                Debug.Log("Eye tracking m_HandTeleportDevice found!", this);
            ...
            foreach (var device in InputSystem.InputSystem.devices)
            {
                ...
                {
                    Debug.Log("Eye gaze m_HandTeleportDevice found!", this);
                    m_EyeTrackingDeviceFound = true;
                    return;
                }
            }

            Debug.LogWarning($"Could not find a m_HandTeleportDevice that supports eye tracking on Awake. {this} has subscribed to m_HandTeleportDevice connected events and will activate the GameObject when an eye tracking m_HandTeleportDevice is connected.", this);
